{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "services/plasma-manager-commands.desktop"."launch-warp" = [];
    };
    configFile = {
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "applications:code";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 342;
