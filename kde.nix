{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "plasmashell"."show-on-mouse-pos" = ["Meta+V" "Redo,Meta+V,Show Clipboard Items at Mouse Position"];
      "plasmashell"."stop current activity" = "Meta+S";
      "plasmashell"."switch to next activity" = "none,,Switch to Next Activity";
      "plasmashell"."switch to previous activity" = "none,,Switch to Previous Activity";
      "plasmashell"."toggle do not disturb" = "none,,Toggle do not disturb";
      "services/plasma-manager-commands.desktop"."launch-konsole" = "Control+Alt+K";
      "services/plasma-manager-commands.desktop"."launch-warp" = "Control+Alt+T";
      "yakuake"."toggle-window-state" = ["F12" "Open,F12,Open/Retract Yakuake"];
    };
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,2,2,8,41,17.486";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."31ad14f6-b0ce-44ae-ad58-7020827eeb1d" = "Default";
      ...
      "kwinrc"."Desktops"."Id_1" = "ecc21d00-d908-4980-916a-14dcff9f09c3";
      "kwinrc"."Desktops"."Id_2" = "660d6d0c-6adb-449d-bbb4-7a12a6f453d2";
      "kwinrc"."Desktops"."Id_3" = "f3ea4f92-8d34-48a0-b983-e8a080738413";
      "kwinrc"."Desktops"."Id_4" = "9786ab33-34ed-4257-8937-117f61e3f31f";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/.snapshots/1/snapshot/moy/test.txt";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 348;
